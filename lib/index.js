...
class ActionCableProvider extends React.Component {
    ...
    constructInitialState(props) {
        ...
        if (this.props.cable) {
            ...
            state.cable = actioncable.createConsumer(this.props.url);
        }
  ...
  static getDerivedStateFromProps(nextProps, prevState){
    // Props not changed
    if (
        (prevState && prevState.cable === nextProps && nextProps.cable) &&
        (prevState && prevState.url === nextProps && nextProps.url)
    ) {
      return;
    }
